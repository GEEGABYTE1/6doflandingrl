...
we are setting IC = 4, which is milder than the final DD-010 spec, to allow for more stable training and evaluation during Phase 2a. 
the curriculum will be completed in Phase 2b, where we will also add support for randomised ICs within each stage.

note: model does learn better with IC=4
"""
...
# thresholds of DD-010
MAX_TOUCH_SPEED = 5.0
MAX_TOUCH_TILT  = 15.0
MAX_POS_ERR     = 150.0

# (alt, vz_nom, pos_off, vel_off, wind) 
IC_STAGES = [
